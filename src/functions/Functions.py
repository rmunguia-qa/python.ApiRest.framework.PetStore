...
class Functions():
    ...
    def set_body_values(self, entity, value):
        # Función que asigna valores que son números como RANDOM
        def set_random_values_int():
            numbers = string.digits

            return ''.join(random.choice(numbers) for i in range(9))

        # Función que asigna valores que son letras como RANDOM
        def set_random_values_str():
        ...
        if value.lower() == "random number":
            value = set_random_values_int()

        if value.lower() == "random":
            value = set_random_values_str()
            if entity.lower() == "email":
                value = set_random_values_str() + "@gmail.com"
